...
{
    [FakturTask]
    class FakturPaymentImport(MetricService metricsService, ILogger<FakturPaymentImport> log) : ETLTask
    {
        ...
        public void ExecuteTask()
        {
            ...
            try
            {
                ...
                paymentFiles = HTTP.DownloadJSON(apiUrlTemplate, log, "payment");
